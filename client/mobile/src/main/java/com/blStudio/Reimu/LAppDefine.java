...
public class LAppDefine
{
    ...
    public static final String BACK_IMAGE_NAME = "image/49309157_p0.jpg" ;


    public static final String MODEL_REIMU      = "live2d/reimu/reimu.model.json";
    public static final String MODEL_HARU       = "live2d/haru/haru_02.model.json";
